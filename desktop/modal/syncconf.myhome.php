...
?>
<div id='div_syncconfMyhomeAlert' style="display: none;"></div>
...
<br/><br/><br/>
<pre id='pre_myhomesyncconf' style='overflow: auto; height: 90%;with:90%;'></pre>
...
<script>
	$.ajax({
		...
		data: {
			action: 'syncconfMyhome',
		},
		dataType: 'json',
		global: false,
		error: function (request, status, error) {
			handleAjaxError(request, status, error, $('#div_syncconfMyhomeAlert'));
		},
		success: function () {
			jeedom.log.autoupdate({
				log : 'myhome.syncconf',
				display : $('#pre_myhomesyncconf'),
